...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'sistemaponto.Funcionario'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'sistemaponto.FuncionarioRegra'
grails.plugin.springsecurity.authority.className = 'sistemaponto.Regra'
grails.plugin.springsecurity.logout.postOnly = false
grails.plugin.springsecurity.auth.loginFormUrl = '/login/autenticar'
...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
        ...
        '/login/negado.gsp':['permitAll'],
        '/notfound.gsp':    ['permitAll'],
        '/pontos':          ['permitAll']
]
